...
Shortfall / our gap: only works for applicants from covered countries with a usable home file —
those outside the network, or with thin home-country history too, are still invisible and still
