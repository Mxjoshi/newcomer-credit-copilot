...
| 5 | UI: Screen 1 (intake plus policy inputs), Screen 2 (live 3 steps), Screen 3 (decision hero plus counterfactuals plus impact view tab) | The three worked examples from the UI flow render correctly |
